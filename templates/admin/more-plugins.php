...
global $nmcontact;
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $nmcontact->plugin_meta['url']?>/css/grid/simplegrid.css" />
<style>
  .content:hover{
...
<p>Create Mailchimp Newsletters with WordPress Posts and Pages and track with graphical reports from Dashboard. Even create subscription forms with visual form designer. Create merge vars and interests.All in one solution for you marketing.</p>
  	...
  	<div class="col-1-3"> <a style="text-decoration: none;" href="http://najeebmedia.com/wordpress-plugin/wordpress-live-currency-exchange-rate-ticker/" title="LIVE CURRENCY TICKER" target="_new">
  	  <div class="content" style="text-align: center;"> <img width="80" style="display: block;margin: 0 auto;" height="80" src="http://i2.wp.com/najeebmedia.com/wp-content/uploads/2015/12/nm-liverticker.png?fit=80%2C80" class="vc_single_image-img attachment-full" alt="nm-message" />
...
<div class="grid grid-pad">
    <div class="col-1-3">
      <a style="text-decoration: none;" href="http://najeebmedia.com/wordpress-plugin/wp-user-registration-form/" title="WP SIMPLE REGISTRATION" target="_new">
       <div class="content" style="text-align: center;">
           <img width="80" style="display: block;margin: 0 auto;" height="80" src="http://i2.wp.com/najeebmedia.com/wp-content/uploads/2015/12/nm-registration.png?fit=80%2C80" class="vc_single_image-img attachment-full" alt="nm-message"><h2>WP SIMPLE REGISTRATION</h2>
<p>If you need to create a nice and simple registration page without going into too much details and options in few minutes just use it. Drag &lsquo;n drop fields, set page permissions by roles, AutoLogin, Facebook Login, Member Listing and much…</p>
       </div>
        </a>
    </div>
    <div class="col-1-3">
