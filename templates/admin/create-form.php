...
$types = array (
		...
		'mask' => array (
				'title' => __ ( 'Mask', 'nm_webcontact' ),
				'desc' => __ ( 'maks', 'nm_webcontact' ),
				'settings' => '',
				'for'	=> 'pro',
		),
		
		'hidden' => array (
				'title' => __ ( 'Hidden', 'nm_webcontact' ),
				'desc' => __ ( 'hidden', 'nm_webcontact' ),
				'settings' => '',
				'for'	=> 'pro',
		),
		
		'autocom' => array (
				'title' => __ ( 'Autocomplete', 'nm_webcontact' ),
				'desc' => __ ( 'Autocomplete', 'nm_webcontact' ),
				'settings' => '',
				'for'	=> 'pro',
		),
		'colorpicker' => array (
				'title' => __ ( 'Color Picker', 'nm_webcontact' ),
				'desc' => __ ( 'Color Picker', 'nm_webcontact' ),
				'settings' => $date_settings,
				'for'	=> 'pro',
		),
		'countries' => array (
				'title' => __ ( 'Countries List', 'nm_webcontact' ),
				'desc' => __ ( 'Countries List', 'nm_webcontact' ),
				'settings' => $date_settings,
				'for'	=> 'pro',
		),
		'preimages' => array (
				'title' => __ ( 'Images Select', 'nm_webcontact' ),
				'desc' => __ ( 'Select images', 'nm_webcontact' ),
				'settings' => $date_settings,
				'for'	=> 'pro',
		),
