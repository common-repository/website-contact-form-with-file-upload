...
class NM_Email extends NM_Inputs{
	...
	*/
	...
	function __construct(){
		...
		$this -> title 		= __ ( 'Email Input', 'nm-webcontact' );
		$this -> desc		= __ ( 'regular email input', 'nm-webcontact' );
	...
	private function get_settings(){
		...
		'send_email' => array (
				'type' => 'checkbox',
				'title' => __ ( 'Send email', 'nm-webcontact' ),
				'desc' => __ ( 'Select this if you want user get this form.', 'nm-webcontact' ) 
		),
		'logic' => array (
				'type' => 'checkbox',
